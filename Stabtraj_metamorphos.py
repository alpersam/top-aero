# -*- coding: utf-8 -*-
"""
Created on Fri Mar 22 10:20:07 2024

@author: alper

Zéphyr - StabTraj.py v1

A faire :
    
    - "compressible" hmm je pense pas car le stabtraj séparé de RC2 existe déjà
    - Mettre sous forme d'application ?
